  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-5 pointer-events-none">
        <div className="absolute top-10 right-10 w-64 h-64 bg-accent rounded-full blur-[80px]"></div>
      </div>
      ...
      <div className="container mx-auto px-6 lg:px-20">
        ...
        <div className="mt-16 relative">
          {/* Vertical Line */}
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-accent via-accent/40 to-transparent opacity-30"></div>
          ...
          <div className="space-y-12">
            {experience.map((exp, index) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-4 md:left-1/2 w-4 h-4 bg-primary-bg border-2 border-accent rounded-full -translate-x-[calc(50%-0.5px)] z-10 shadow-accent-dot"></div>
